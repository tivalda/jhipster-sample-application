package com.gs2e.datacollector.config;
...
@Configuration
@EnableMongock
@EnableElasticsearchRepositories("com.gs2e.datacollector.repository.search")
@EnableMongoRepositories(
    basePackages = "com.gs2e.datacollector.repository",
